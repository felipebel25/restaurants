export const privacyPolicies = [
    {
        ...
        description: `Last updated: December 28, 2023
...
For the purposes of this Privacy Policy:
  ...
  * Application refers to Eatst Orders, the software program provided by the
    Company.

  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Agreement) refers to Eatsy Orders, New York in the United States.
  ...
  * Website refers to Eatsy Orders, accessible from <https://eatsyorders.co/>
...
`
    },
    {
        ...
        description: `While using Our Application, in order to provide features of Our Application,
...
`
...

    {
        ...
        * By email: support@eatsyorders.com
      
        * By visiting this page on our website: https://www.eatsyorders.co
      
        * By phone number: +1 929 413 30 80
`
    },
]