...
export const homeText = {
  ...
  FAQ: {
    ...
    cards: [
      {
        id: "FAQ-what",
        title: <>What is <Bold>Eatsy.orders.com?</Bold></>,
        description: "Eatsy Orders is an application that seeks to improve our customers' experience when ordering. Forget about printed menus and offer an updated and friendly view of your products. We assure you that you will love it!"
      },
      {
        id: "FAQ-how",
        title: <>How to contact us?</>,
        description: "You can use one of our contact networks or also subscribe to stay up to date with all our updates and new benefits."
      },
      {
        id: "FAQ-benefits",
        title: <>What are the benefits of the application?</>,
        description: "Get more automated control of your menus and orders. Much more comfortable, organized in one place with the added bonus of adapting your restaurant's appearence. Give your diner a successful experience in an effective way."
      },
    ]
  },
  TakeControl: {
