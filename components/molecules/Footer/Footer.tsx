            ...
            <Container>
                ...
                >
                    ...
                    <Stack
                        ...
                        <Typography variant="overline" color="inherit">2023 - Eatsy Orders</Typography>
                        <Stack direction={'row'} spacing={'1.5rem'}>
                            <IconButton color="inherit"> <FacebookRounded /></IconButton>
                    ...
                    <Stack spacing={'1.5rem'}>
                        ...
                        <Typography variant="subtitle1" color="inherit">support@eatsyorders.com</Typography>
                        <Typography variant="subtitle1" color="inherit"><strong>Sales:</strong> +1 555 5555</Typography>
                        <Typography variant="subtitle1" color="inherit"><strong>Support:</strong> +1 555 5555 </Typography>
                    </Stack>
                    ...
                    <Stack spacing={'1.5rem'}>
                        <Typography variant="h6" color="inherit">Legal</Typography>
